...
import 'package:flutter_ai_chat/ui/views/chat/chat_view.dart' as _i3;
import 'package:flutter_ai_chat/ui/views/startup/startup_view.dart' as _i2;
...
class Routes {
  ...
  static const all = <String>{startupView, chatView};
}
